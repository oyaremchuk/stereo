...
//****************************************************************************************************************************************************
	...
	Mat temp_left(7,7,img_left.type(), Scalar(0,0,0));
	Mat temp_right(7,7,img_right.type(), Scalar(0,0,0));
	...
	for (int j = right_point_start.y + 3; j < right_point_end.y - 3; j++)
	{
		roi_left.y = left_point_start.y + left_point_y_shift;
		for (int i = right_point_start.x + 3; i < right_point_end.x - 3; i++)
		{
			
			img_right.row(j - 3).col(i - 3).copyTo(temp_right.row(0).col(0));
			img_right.row(j - 3).col(i - 2).copyTo(temp_right.row(0).col(1));
			img_right.row(j - 3).col(i - 1).copyTo(temp_right.row(0).col(2));
			img_right.row(j - 3).col(  i  ).copyTo(temp_right.row(0).col(3));
			img_right.row(j - 3).col(i + 1).copyTo(temp_right.row(0).col(4));
			img_right.row(j - 3).col(i + 2).copyTo(temp_right.row(0).col(5));
			img_right.row(j - 3).col(i + 3).copyTo(temp_right.row(0).col(6));
			
			img_right.row(j - 2).col(i - 3).copyTo(temp_right.row(1).col(0));
			img_right.row(j - 2).col(i - 2).copyTo(temp_right.row(1).col(1));
			img_right.row(j - 2).col(i - 1).copyTo(temp_right.row(1).col(2));
			img_right.row(j - 2).col(  i  ).copyTo(temp_right.row(1).col(3));
			img_right.row(j - 2).col(i + 1).copyTo(temp_right.row(1).col(4));
			img_right.row(j - 2).col(i + 2).copyTo(temp_right.row(1).col(5));
			img_right.row(j - 2).col(i + 3).copyTo(temp_right.row(1).col(6));

			img_right.row(j - 1).col(i - 3).copyTo(temp_right.row(2).col(0));
			img_right.row(j - 1).col(i - 2).copyTo(temp_right.row(2).col(1));
			img_right.row(j - 1).col(i - 1).copyTo(temp_right.row(2).col(2));
			img_right.row(j - 1).col(  i  ).copyTo(temp_right.row(2).col(3));
			img_right.row(j - 1).col(i + 1).copyTo(temp_right.row(2).col(4));
			img_right.row(j - 1).col(i + 2).copyTo(temp_right.row(2).col(5));
			img_right.row(j - 1).col(i + 3).copyTo(temp_right.row(2).col(6));

			img_right.row(  j  ).col(i - 3).copyTo(temp_right.row(3).col(0));
			img_right.row(  j  ).col(i - 2).copyTo(temp_right.row(3).col(1));
			img_right.row(  j  ).col(i - 1).copyTo(temp_right.row(3).col(2));
			img_right.row(  j  ).col(  i  ).copyTo(temp_right.row(3).col(3));
			img_right.row(  j  ).col(i + 1).copyTo(temp_right.row(3).col(4));
			img_right.row(  j  ).col(i + 2).copyTo(temp_right.row(3).col(5));
			img_right.row(  j  ).col(i + 3).copyTo(temp_right.row(3).col(6));

			img_right.row(j + 1).col(i - 3).copyTo(temp_right.row(4).col(0));
			img_right.row(j + 1).col(i - 2).copyTo(temp_right.row(4).col(1));
			img_right.row(j + 1).col(i - 1).copyTo(temp_right.row(4).col(2));
			img_right.row(j + 1).col(  i  ).copyTo(temp_right.row(4).col(3));
			img_right.row(j + 1).col(i + 1).copyTo(temp_right.row(4).col(4));
			img_right.row(j + 1).col(i + 2).copyTo(temp_right.row(4).col(5));
			img_right.row(j + 1).col(i + 3).copyTo(temp_right.row(4).col(6));

			img_right.row(j + 2).col(i - 3).copyTo(temp_right.row(5).col(0));
			img_right.row(j + 2).col(i - 2).copyTo(temp_right.row(5).col(1));
			img_right.row(j + 2).col(i - 1).copyTo(temp_right.row(5).col(2));
			img_right.row(j + 2).col(  i  ).copyTo(temp_right.row(5).col(3));
			img_right.row(j + 2).col(i + 1).copyTo(temp_right.row(5).col(4));
			img_right.row(j + 2).col(i + 2).copyTo(temp_right.row(5).col(5));
			img_right.row(j + 2).col(i + 3).copyTo(temp_right.row(5).col(6));

			
			img_right.row(j + 3).col(i - 3).copyTo(temp_right.row(6).col(0));
			img_right.row(j + 3).col(i - 2).copyTo(temp_right.row(6).col(1));
			img_right.row(j + 3).col(i - 1).copyTo(temp_right.row(6).col(2));
			img_right.row(j + 3).col(  i  ).copyTo(temp_right.row(6).col(3));
			img_right.row(j + 3).col(i + 1).copyTo(temp_right.row(6).col(4));
			img_right.row(j + 3).col(i + 2).copyTo(temp_right.row(6).col(5));
			img_right.row(j + 3).col(i + 3).copyTo(temp_right.row(6).col(6));
			
			roi_left.x = left_point_start.x + left_point_x_shift - 4;
